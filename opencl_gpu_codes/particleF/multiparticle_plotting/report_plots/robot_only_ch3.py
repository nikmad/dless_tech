...
#plt.scatter(data[ i*10000 : (i+1)*10000-1 , 0 ], data[  i*10000 : (i+1)*10000-1 ,1], s=150, c=vect*10, marker= 'o', linewidths=1)
#plt.colorbar()
...
plt.savefig("robot_only.pdf", facecolor='white', format='pdf', dpi=50)	
#plt.show(1)
