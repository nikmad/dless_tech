...
{       
    ...
    {	
	   // prob_dist = gaussian_kernel(good_line[idx_dim1].dist, allnoises->forwardNoise,
      //   best_line[gl].dist);	
	   ...
	   // prob_dist *= gaussian_kernel( good_line[idx_dim1].linvel, 
      //   allnoises->senseNoise, best_line[gl].linvel);
	   // prob_dist *= gaussian_kernel( good_line[idx_dim1].angvel, 
      //   allnoises->senseNoise, best_line[gl].angvel);
    ...
    good_line_out[idx_dim1].linvel = good_line[idx_dim1].linvel; 
    good_line_out[idx_dim1].angvel = good_line[idx_dim1].angvel; 
