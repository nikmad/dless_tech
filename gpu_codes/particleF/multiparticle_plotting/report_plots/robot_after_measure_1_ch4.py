...
f1.subplots_adjust(left=0.08, right=1.02, hspace=0.3, wspace=0.2, top=0.95, bottom=0.05)
...
plt.savefig("robot_after_measure_1.eps", facecolor='white', format='eps', dpi=50)	
